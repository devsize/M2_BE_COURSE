...
{
    const CONFIG_PATH = 'slayer_test/settings/show_cms_block_on_plp'; // your checkbox
    ...
    public function getValues()
    {
        ...
        foreach ($objectManager->create('Slayer\Test\Model\Config\Source\Checkbox')->toOptionArray() as $value) {
